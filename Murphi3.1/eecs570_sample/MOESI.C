...
char *mu_1_MessageType::values[] = {"GetS","GetM","Data","E_Data","FwdGetS","FwdGetM","FwdAck","Inv","InvAck","PutS","PutM","PutO","PutE","Ack_Count","NACK","PutAck",NULL };
...
class mu_1__type_0: public mu__byte
{
 public:
  ...
  mu_1__type_0 (char *name, int os): mu__byte(23, 36, 4, name, os) {};
  mu_1__type_0 (void): mu__byte(23, 36, 4) {};
  mu_1__type_0 (int val): mu__byte(23, 36, 4, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1__type_2: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1__type_2::values[ int(val) - 37] );
    else return ( s << "Undefined" );
  };

  mu_1__type_2 (char *name, int os): mu__byte(37, 55, 5, name, os) {};
  mu_1__type_2 (void): mu__byte(37, 55, 5) {};
  mu_1__type_2 (int val): mu__byte(37, 55, 5, "Parameter or function result.", 0)
  {
     operator=(val);
  };
  char * Name() { return values[ value() -37]; };
  virtual void Permute(PermSet& Perm, int i);
  virtual void SimpleCanonicalize(PermSet& Perm);
  virtual void Canonicalize(PermSet& Perm);
  virtual void SimpleLimit(PermSet& Perm);
...
char *mu_1__type_2::values[] = {"P_I","P_IS_D","P_IM_A_D","P_IM_A","P_IM_D","P_S","P_SM_A_D","P_SM_A","P_SM_D","P_E","P_O","P_OM_AC","P_OM_A","P_OI_A","P_M","P_MI_A","P_EI_A","P_SI_A","P_II_A",NULL };
...
class mu_1__type_4_id: public mu__byte
{
 public:
  ...
  inline operator int() const { return value(); };
  mu_1__type_4_id () : mu__byte(0,7,0) {};
  mu_1__type_4_id (int val) : mu__byte(0,7,0, "Parameter or function result.",0) {operator=(val); };
  char * Name() { return tsprintf("%d", value()); };
};
class mu_1__type_4
{
...
void mu_1__type_5::set_self( char *n, int os)
  {
    int i=0;
    name = n;
array[i].set_self_ar(n,"HomeType", i * 640 + os);i++;
array[i].set_self_ar(n,"Proc_1", i * 640 + os);i++;
array[i].set_self_ar(n,"Proc_2", i * 640 + os);i++;
array[i].set_self_ar(n,"Proc_3", i * 640 + os);i++;
}
...
void mu_1__type_7::set_self( char *n, int os)
  {
    int i=0;
    name = n;
array[i].set_self_ar(n,"HomeType", i * 144 + os);i++;
...
const int mu_NACK = 21;
const int mu_PutAck = 22;
const int mu_H_I = 23;
const int mu_H_S = 24;
const int mu_H_E = 25;
const int mu_H_M = 26;
const int mu_H_O = 27;
const int mu_H_SM_A = 28;
const int mu_H_MM_A = 29;
const int mu_H_EM_A = 30;
const int mu_H_EO_A = 31;
const int mu_H_OO_A = 32;
const int mu_H_OM_oA_A = 33;
const int mu_H_OM_A = 34;
const int mu_H_OM_oA = 35;
const int mu_H_MO_A = 36;
const int mu_P_I = 37;
const int mu_P_IS_D = 38;
const int mu_P_IM_A_D = 39;
const int mu_P_IM_A = 40;
const int mu_P_IM_D = 41;
const int mu_P_S = 42;
const int mu_P_SM_A_D = 43;
const int mu_P_SM_A = 44;
const int mu_P_SM_D = 45;
const int mu_P_E = 46;
const int mu_P_O = 47;
const int mu_P_OM_AC = 48;
const int mu_P_OM_A = 49;
const int mu_P_OI_A = 50;
const int mu_P_M = 51;
const int mu_P_MI_A = 52;
const int mu_P_EI_A = 53;
const int mu_P_SI_A = 54;
const int mu_P_II_A = 55;
...
/*** Variable declaration ***/
mu_1__type_7 mu_InBox("InBox",2776);
...
public:
  ...
  void NextRule(unsigned & what_rule)
  {
    ...
    mu_n.unionassign(r % 4);
    r = r / 4;
    while (what_rule < 40 && mu_midx.value()<8 )
      {
...
bool Condition(unsigned r)
{
  ...
  if (r>=55 && r<=57) return R7.Condition(r-55);
  if (r>=58 && r<=60) return R8.Condition(r-58);
  if (r>=61 && r<=63) return R9.Condition(r-61);
  if (r>=64 && r<=66) return R10.Condition(r-64);
  if (r>=67 && r<=72) return R11.Condition(r-67);
...
void Code(unsigned r)
{
  ...
  if (r>=55 && r<=57) { R7.Code(r-55); return; } 
  if (r>=58 && r<=60) { R8.Code(r-58); return; } 
  if (r>=61 && r<=63) { R9.Code(r-61); return; } 
  if (r>=64 && r<=66) { R10.Code(r-64); return; } 
  if (r>=67 && r<=72) { R11.Code(r-67); return; } 
}
int Priority(unsigned short r)
{
  ...
  if (r>=55 && r<=57) { return R7.Priority(); } 
  if (r>=58 && r<=60) { return R8.Priority(); } 
  if (r>=61 && r<=63) { return R9.Priority(); } 
  if (r>=64 && r<=66) { return R10.Priority(); } 
  if (r>=67 && r<=72) { return R11.Priority(); } 
}
char * Name(unsigned r)
{
  ...
  if (r>=55 && r<=57) return R7.Name(r-55);
  if (r>=58 && r<=60) return R8.Name(r-58);
  if (r>=61 && r<=63) return R9.Name(r-61);
  if (r>=64 && r<=66) return R10.Name(r-64);
  if (r>=67 && r<=72) return R11.Name(r-67);
  return NULL;
}
};
const unsigned numrules = 73;

/********************
  parameter
 ********************/
#define RULES_IN_WORLD 73
...
/********************
  Invariant records
 ********************/
int mu__invariant_17() // Invariant "values in shared state or E match memory"
{
bool mu__quant18; 
mu__quant18 = TRUE;
{
...
bool mu__boolexpr20;
bool mu__boolexpr21;
  if (!((mu_HomeNode.mu_state) == (mu_H_S))) mu__boolexpr21 = FALSE ;
  else {
  mu__boolexpr21 = ((mu_Procs[mu_n].mu_state) == (mu_P_S)) ; 
}
  if (mu__boolexpr21) mu__boolexpr20 = TRUE ;
  else {
bool mu__boolexpr22;
  if (!((mu_HomeNode.mu_state) == (mu_H_E))) mu__boolexpr22 = FALSE ;
  else {
  mu__boolexpr22 = ((mu_Procs[mu_n].mu_state) == (mu_P_E)) ; 
}
  mu__boolexpr20 = (mu__boolexpr22) ; 
}
  if (!(mu__boolexpr20)) mu__boolexpr19 = TRUE ;
  else {
  mu__boolexpr19 = ((mu_HomeNode.mu_val) == (mu_Procs[mu_n].mu_val)) ; 
}
if ( !(mu__boolexpr19) )
...
bool mu__condition_23() // Condition for Rule "values in shared state or E match memory"
{
...
int mu__invariant_24() // Invariant "values in memory matches value of last write, when shared or invalid"
{
bool mu__quant25; 
mu__quant25 = TRUE;
{
...
bool mu__boolexpr26;
bool mu__boolexpr27;
  if ((mu_HomeNode.mu_state) == (mu_H_S)) mu__boolexpr27 = TRUE ;
  else {
  mu__boolexpr27 = ((mu_HomeNode.mu_state) == (mu_H_I)) ; 
}
...
bool mu__condition_28() // Condition for Rule "values in memory matches value of last write, when shared or invalid"
{
...
int mu__invariant_29() // Invariant "Homenode.state is in I or M or E implies empty sharer list"
{
bool mu__boolexpr30;
bool mu__boolexpr31;
bool mu__boolexpr32;
  if ((mu_HomeNode.mu_state) == (mu_H_I)) mu__boolexpr32 = TRUE ;
  else {
  mu__boolexpr32 = ((mu_HomeNode.mu_state) == (mu_H_M)) ; 
}
  if (mu__boolexpr32) mu__boolexpr31 = TRUE ;
  else {
  mu__boolexpr31 = ((mu_HomeNode.mu_state) == (mu_H_E)) ; 
}
...
/*** end multisetcount 5 declaration ***/
  mu__boolexpr30 = ((mu__intexpr33) == (0)) ; 
}
return mu__boolexpr30;
};

bool mu__condition_34() // Condition for Rule "Homenode.state is in I or M or E implies empty sharer list"
{
...
int mu__invariant_35() // Invariant "value is undefined while invalid"
{
bool mu__quant36; 
mu__quant36 = TRUE;
{
for(int mu_n = 1; mu_n <= 3; mu_n++) {
bool mu__boolexpr37;
  if (!((mu_Procs[mu_n].mu_state) == (mu_P_I))) mu__boolexpr37 = TRUE ;
  else {
  mu__boolexpr37 = (mu_Procs[mu_n].mu_val.isundefined()) ; 
}
if ( !(mu__boolexpr37) )
...
bool mu__condition_38() // Condition for Rule "value is undefined while invalid"
{
...
int mu__invariant_39() // Invariant "P.state is in S or M or E match last write"
{
bool mu__quant40; 
mu__quant40 = TRUE;
{
...
bool mu__boolexpr42;
bool mu__boolexpr43;
  if ((mu_Procs[mu_n].mu_state) == (mu_P_S)) mu__boolexpr43 = TRUE ;
  else {
  mu__boolexpr43 = ((mu_Procs[mu_n].mu_state) == (mu_P_M)) ; 
}
  if (mu__boolexpr43) mu__boolexpr42 = TRUE ;
  else {
  mu__boolexpr42 = ((mu_Procs[mu_n].mu_state) == (mu_P_E)) ; 
}
  if (!(mu__boolexpr42)) mu__boolexpr41 = TRUE ;
  else {
  mu__boolexpr41 = ((mu_Procs[mu_n].mu_val) == (mu_LastWrite)) ; 
}
if ( !(mu__boolexpr41) )
...
bool mu__condition_44() // Condition for Rule "P.state is in S or M or E match last write"
{
...
int mu__invariant_45() // Invariant "value in memory matches value of last write, when invalid"
{
bool mu__boolexpr46;
  if (!((mu_HomeNode.mu_state) == (mu_H_I))) mu__boolexpr46 = TRUE ;
  else {
  mu__boolexpr46 = ((mu_HomeNode.mu_val) == (mu_LastWrite)) ; 
}
return mu__boolexpr46;
};

bool mu__condition_47() // Condition for Rule "value in memory matches value of last write, when invalid"
{
...
int mu__invariant_48() // Invariant "HomeNode.state is in I or S implies empty owner"
{
bool mu__boolexpr49;
bool mu__boolexpr50;
  if ((mu_HomeNode.mu_state) == (mu_H_I)) mu__boolexpr50 = TRUE ;
  else {
  mu__boolexpr50 = ((mu_HomeNode.mu_state) == (mu_H_S)) ; 
}
  if (!(mu__boolexpr50)) mu__boolexpr49 = TRUE ;
  else {
  mu__boolexpr49 = (mu_HomeNode.mu_owner.isundefined()) ; 
}
return mu__boolexpr49;
};

bool mu__condition_51() // Condition for Rule "HomeNode.state is in I or S implies empty owner"
{
...
{"HomeNode.state is in I or S implies empty owner", &mu__condition_51, NULL, FALSE},
{"value in memory matches value of last write, when invalid", &mu__condition_47, NULL, FALSE},
{"P.state is in S or M or E match last write", &mu__condition_44, NULL, FALSE},
{"value is undefined while invalid", &mu__condition_38, NULL, FALSE},
{"Homenode.state is in I or M or E implies empty sharer list", &mu__condition_34, NULL, FALSE},
{"values in memory matches value of last write, when shared or invalid", &mu__condition_28, NULL, FALSE},
{"values in shared state or E match memory", &mu__condition_23, NULL, FALSE},
};
