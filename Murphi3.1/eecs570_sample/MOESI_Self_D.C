/******************************
  Program "MOESI_Self_D.m" compiled by "Murphi Release 3.1"

  Murphi Last Modefied Date: "Jan 29 1999"
  Murphi Last Compiled date: "Mar 10 2023"
 ******************************/
...
#define PROTOCOL_NAME "MOESI_Self_D"
...
class mu_1_Ack_Cnt: public mu__long
{
 public:
  inline int operator=(int val) { return mu__long::operator=(val); };
  inline int operator=(const mu_1_Ack_Cnt& val) { return mu__long::operator=((int) val); };
  mu_1_Ack_Cnt (char *name, int os): mu__long(-3, 3, 3, name, os) {};
  mu_1_Ack_Cnt (void): mu__long(-3, 3, 3) {};
  mu_1_Ack_Cnt (int val): mu__long(-3, 3, 3, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
/*** end of subrange decl ***/
mu_1_Ack_Cnt mu_1_Ack_Cnt_undefined_var;
...
char *mu_1_MessageType::values[] = {"GetS","GetM","Data","E_Data","FwdGetS","FwdGetM","FwdAck","Inv","InvAck","PutS","PutM","PutO","PutE","Ack_Count","DowngradeMtoE","DowngradeAck","NACK","PutAck",NULL };
...
friend int CompareWeight(mu_1_Message& a, mu_1_Message& b)
  {
    ...
    if (w!=0) return w;
    w = CompareWeight(a.mu_fwd, b.mu_fwd);
    if (w!=0) return w;
  return 0;
}
...
virtual bool ismember() { Error.Error("Checking membership for a non-base type"); return TRUE;}
  mu_1_Message& operator= (const mu_1_Message& from) {
    ...
    mu_fwd.value(from.mu_fwd.value());
    return *this;
  };
};
...
void mu_1_Message::set_self(char *n, int os)
{
  ...
  mu_ack_cnt.set_self_2(name, ".ack_cnt", os + 32 );
  mu_fwd.set_self_2(name, ".fwd", os + 64 );
}
...
class mu_1__type_0: public mu__byte
{
 public:
  ...
  mu_1__type_0 (char *name, int os): mu__byte(25, 38, 4, name, os) {};
  mu_1__type_0 (void): mu__byte(25, 38, 4) {};
  mu_1__type_0 (int val): mu__byte(25, 38, 4, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
char *mu_1__type_0::values[] = {"H_I","H_S","H_E","H_M","H_O","H_SM_A","H_MM_A","H_EM_A","H_EO_A","H_OO_A","H_OM_oA_A","H_OM_A","H_OM_oA","H_MO_A",NULL };
...
class mu_1__type_2: public mu__byte
{
 public:
  ...
  mu_1__type_2 (char *name, int os): mu__byte(39, 58, 5, name, os) {};
  mu_1__type_2 (void): mu__byte(39, 58, 5) {};
  mu_1__type_2 (int val): mu__byte(39, 58, 5, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
char *mu_1__type_2::values[] = {"P_I","P_IS_D","P_IM_A_D","P_IM_A","P_IM_D","P_S","P_SM_A_D","P_SM_A","P_SM_D","P_E","P_O","P_OM_AC","P_OM_A","P_OI_A","P_M","P_MI_A","P_ME_A","P_EI_A","P_SI_A","P_II_A",NULL };
...
void mu_1__type_5::set_self( char *n, int os)
  {
    int i=0;
    name = n;
array[i].set_self_ar(n,"HomeType", i * 480 + os);i++;
array[i].set_self_ar(n,"Proc_1", i * 480 + os);i++;
array[i].set_self_ar(n,"Proc_2", i * 480 + os);i++;
array[i].set_self_ar(n,"Proc_3", i * 480 + os);i++;
}
...
void mu_1__type_7::set_self( char *n, int os)
  {
    int i=0;
    name = n;
array[i].set_self_ar(n,"HomeType", i * 216 + os);i++;
...
const int mu_request_chanel = 0;
const int mu_response_chanel = 1;
const int mu_downgrade_channel = 2;
const int mu_QMax = 2;
...
const int mu_GetM = 8;
const int mu_Data = 9;
const int mu_E_Data = 10;
const int mu_FwdGetS = 11;
const int mu_FwdGetM = 12;
const int mu_FwdAck = 13;
const int mu_Inv = 14;
const int mu_InvAck = 15;
const int mu_PutS = 16;
const int mu_PutM = 17;
const int mu_PutO = 18;
const int mu_PutE = 19;
const int mu_Ack_Count = 20;
const int mu_DowngradeMtoE = 21;
const int mu_DowngradeAck = 22;
const int mu_NACK = 23;
const int mu_PutAck = 24;
const int mu_H_I = 25;
const int mu_H_S = 26;
const int mu_H_E = 27;
const int mu_H_M = 28;
const int mu_H_O = 29;
const int mu_H_SM_A = 30;
const int mu_H_MM_A = 31;
const int mu_H_EM_A = 32;
const int mu_H_EO_A = 33;
const int mu_H_OO_A = 34;
const int mu_H_OM_oA_A = 35;
const int mu_H_OM_A = 36;
const int mu_H_OM_oA = 37;
const int mu_H_MO_A = 38;
const int mu_P_I = 39;
const int mu_P_IS_D = 40;
const int mu_P_IM_A_D = 41;
const int mu_P_IM_A = 42;
const int mu_P_IM_D = 43;
const int mu_P_S = 44;
const int mu_P_SM_A_D = 45;
const int mu_P_SM_A = 46;
const int mu_P_SM_D = 47;
const int mu_P_E = 48;
const int mu_P_O = 49;
const int mu_P_OM_AC = 50;
const int mu_P_OM_A = 51;
const int mu_P_OI_A = 52;
const int mu_P_M = 53;
const int mu_P_MI_A = 54;
const int mu_P_ME_A = 55;
const int mu_P_EI_A = 56;
const int mu_P_SI_A = 57;
const int mu_P_II_A = 58;
...
/*** Variable declaration ***/
mu_1__type_7 mu_InBox("InBox",2136);
...
void mu_Send(const mu_1_MessageType& mu_mtype, const mu_1_Node& mu_dst, const mu_1_Node& mu_src, const mu_1_VCType& mu_vc, const mu_1_Value& mu_val, const mu_1_Ack_Cnt& mu_ack_cnt, const mu_1_Node& mu_fwd)
{
/*** Variable declaration ***/
...
if (mu_fwd.isundefined())
  mu_msg.mu_fwd.undefine();
else
  mu_msg.mu_fwd = mu_fwd;
...
cout << "\n";
Error.Error("Error:  ahhUnhandled message type!");
};
/*** end procedure declaration ***/
...
if ( (mu_n) != (mu_rqst) )
{
mu_Send ( mu_Inv, mu_n, (int)mu_HomeType, mu_request_chanel, mu_1_Value_undefined_var, mu_1_Ack_Cnt_undefined_var, mu_rqst );
}
}
};
};
...
mu_Send ( mu_E_Data, mu_msg.mu_src, (int)mu_HomeType, mu_response_chanel, mu_HomeNode.mu_val, (int)mu_cnt, mu_1_Node_undefined_var );
break;
case mu_GetM:
mu_HomeNode.mu_state = mu_H_M;
mu_HomeNode.mu_owner = mu_msg.mu_src;
mu_Send ( mu_Data, mu_msg.mu_src, (int)mu_HomeType, mu_response_chanel, mu_HomeNode.mu_val, (int)mu_cnt, mu_1_Node_undefined_var );
break;
case mu_PutS:
mu_Send ( mu_PutAck, mu_msg.mu_src, (int)mu_HomeType, mu_response_chanel, mu_1_Value_undefined_var, mu_1_Ack_Cnt_undefined_var, mu_1_Node_undefined_var );
break;
case mu_PutM:
if ( !((mu_HomeNode.mu_owner) != (mu_msg.mu_src)) ) Error.Error("Assertion failed: error: src is owner when HomeNode state is Invalid:PutM");
mu_Send ( mu_PutAck, mu_msg.mu_src, (int)mu_HomeType, mu_response_chanel, mu_1_Value_undefined_var, mu_1_Ack_Cnt_undefined_var, mu_1_Node_undefined_var );
break;
case mu_PutO:
if ( !((mu_HomeNode.mu_owner) != (mu_msg.mu_src)) ) Error.Error("Assertion failed: error: src is owner when HomeNode state is Invalid:PutO");
mu_Send ( mu_PutAck, mu_msg.mu_src, (int)mu_HomeType, mu_response_chanel, mu_1_Value_undefined_var, mu_1_Ack_Cnt_undefined_var, mu_1_Node_undefined_var );
break;
default:
...
mu_Send ( mu_Data, mu_msg.mu_src, (int)mu_HomeType, mu_response_chanel, mu_HomeNode.mu_val, 0, mu_1_Node_undefined_var );
}
else
{
mu_HomeNode.mu_state = mu_H_SM_A;
mu_HomeNode.mu_owner = mu_msg.mu_src;
mu_SendInvReqToSharers ( mu_msg.mu_src );
mu_Send ( mu_Data, mu_msg.mu_src, (int)mu_HomeType, mu_response_chanel, mu_HomeNode.mu_val, (mu_cnt) - (1), mu_1_Node_undefined_var );
...
break;
case mu_PutM:
if ( !((mu_msg.mu_src) != (mu_HomeNode.mu_owner)) ) Error.Error("Assertion failed: Writeback from owner rather than nonOwner:PUTM");
if ( mu_IsSharer( mu_msg.mu_src ) )
{
if ( (mu_cnt) == (1) )
{
...
break;
case mu_PutO:
if ( !((mu_msg.mu_src) != (mu_HomeNode.mu_owner)) ) Error.Error("Assertion failed: Writeback from owner rather than nonOwner:PutO");
if ( mu_IsSharer( mu_msg.mu_src ) )
{
if ( (mu_cnt) == (1) )
{
...
{
mu_Send ( mu_FwdGetS, mu_HomeNode.mu_owner, (int)mu_HomeType, mu_request_chanel, mu_1_Value_undefined_var, mu_1_Ack_Cnt_undefined_var, mu_msg.mu_src );
mu_AddToSharersList ( mu_msg.mu_src );
mu_HomeNode.mu_state = mu_H_OO_A;
}
else
{
mu_ErrorUnhandledMsg ( mu_msg, (int)mu_HomeType );
...
if ( (mu_cnt) == (0) )
{
mu_HomeNode.mu_state = mu_H_OM_oA;
mu_Send ( mu_Ack_Count, mu_msg.mu_src, (int)mu_HomeType, mu_response_chanel, mu_1_Value_undefined_var, 0, mu_1_Node_undefined_var );
}
else
{
mu_HomeNode.mu_state = mu_H_OM_oA_A;
mu_Send ( mu_Ack_Count, mu_msg.mu_src, (int)mu_HomeType, mu_response_chanel, mu_1_Value_undefined_var, (int)mu_cnt, mu_1_Node_undefined_var );
mu_SendInvReqToSharers ( mu_msg.mu_src );
}
}
else
...
if ( (mu_cnt) == (1) )
{
mu_Send ( mu_FwdGetM, mu_HomeNode.mu_owner, (int)mu_HomeType, mu_request_chanel, mu_1_Value_undefined_var, mu_1_Ack_Cnt_undefined_var, mu_msg.mu_src );
mu_Send ( mu_Ack_Count, mu_msg.mu_src, (int)mu_HomeType, mu_response_chanel, mu_1_Value_undefined_var, 0, mu_1_Node_undefined_var );
mu_HomeNode.mu_state = mu_H_OM_oA;
mu_HomeNode.mu_owner = mu_msg.mu_src;
mu_HomeNode.mu_sharers.undefine();
...
{
mu_HomeNode.mu_state = mu_H_OM_oA_A;
mu_Send ( mu_Ack_Count, mu_msg.mu_src, (int)mu_HomeType, mu_response_chanel, mu_1_Value_undefined_var, (mu_cnt) - (1), mu_1_Node_undefined_var );
mu_SendInvReqToSharers ( mu_msg.mu_src );
mu_Send ( mu_FwdGetM, mu_HomeNode.mu_owner, (int)mu_HomeType, mu_request_chanel, mu_1_Value_undefined_var, mu_1_Ack_Cnt_undefined_var, mu_msg.mu_src );
mu_RemoveFromSharersList ( mu_msg.mu_src );
mu_HomeNode.mu_owner = mu_msg.mu_src;
...
case mu_H_M:
switch ((int) mu_msg.mu_mtype) {
case mu_DowngradeMtoE:
mu_Send ( mu_DowngradeAck, mu_msg.mu_src, (int)mu_HomeType, mu_response_chanel, mu_1_Value_undefined_var, mu_1_Ack_Cnt_undefined_var, mu_msg.mu_src );
mu_HomeNode.mu_val = mu_msg.mu_val;
mu_HomeNode.mu_state = mu_H_E;
break;
case mu_GetS:
mu_Send ( mu_FwdGetS, mu_HomeNode.mu_owner, (int)mu_HomeType, mu_request_chanel, mu_1_Value_undefined_var, mu_1_Ack_Cnt_undefined_var, mu_msg.mu_src );
mu_AddToSharersList ( mu_msg.mu_src );
mu_HomeNode.mu_state = mu_H_MO_A;
break;
case mu_GetM:
mu_HomeNode.mu_state = mu_H_MM_A;
mu_Send ( mu_FwdGetM, mu_HomeNode.mu_owner, (int)mu_HomeType, mu_request_chanel, mu_1_Value_undefined_var, mu_1_Ack_Cnt_undefined_var, mu_msg.mu_src );
mu_HomeNode.mu_owner = mu_msg.mu_src;
break;
case mu_PutS:
...
mu_Send ( mu_FwdGetS, mu_HomeNode.mu_owner, (int)mu_HomeType, mu_request_chanel, mu_1_Value_undefined_var, mu_1_Ack_Cnt_undefined_var, mu_msg.mu_src );
mu_AddToSharersList ( mu_msg.mu_src );
mu_HomeNode.mu_state = mu_H_EO_A;
break;
case mu_GetM:
mu_HomeNode.mu_state = mu_H_EM_A;
mu_Send ( mu_FwdGetM, mu_HomeNode.mu_owner, (int)mu_HomeType, mu_request_chanel, mu_1_Value_undefined_var, mu_1_Ack_Cnt_undefined_var, mu_msg.mu_src );
mu_HomeNode.mu_owner = mu_msg.mu_src;
break;
case mu_PutS:
...
break;
case mu_DowngradeMtoE:
mu_Send ( mu_NACK, mu_msg.mu_src, (int)mu_HomeType, mu_response_chanel, mu_1_Value_undefined_var, mu_1_Ack_Cnt_undefined_var, mu_1_Node_undefined_var );
break;
case mu_GetS:
mu_msg_processed = mu_false;
break;
...
break;
case mu_FwdAck:
mu_HomeNode.mu_state = mu_H_OM_A;
mu_HomeNode.mu_val = mu_msg.mu_val;
break;
case mu_InvAck:
if ( mu_IsSharer( mu_msg.mu_src ) )
...
{
  mu_1_Ack_Cnt& mu_pack_count = mu_Procs[mu_p].mu_ack_cnt;
switch ((int) mu_ps) {
case mu_P_I:
switch ((int) mu_msg.mu_mtype) {
case mu_Data:
...
switch ((int) mu_msg.mu_mtype) {
case mu_Ack_Count:
mu_pack_count = (mu_pack_count) + (mu_msg.mu_ack_cnt);
if ( (mu_pack_count) == (0) )
{
mu_ps = mu_P_IM_D;
}
...
{
bool mu__boolexpr16;
  if (!(!(mu_msg.mu_ack_cnt.isundefined()))) mu__boolexpr16 = FALSE ;
  else {
  mu__boolexpr16 = ((mu_msg.mu_ack_cnt) == (0)) ; 
}
if ( mu__boolexpr16 )
{
mu_ps = mu_P_M;
...
switch ((int) mu_msg.mu_mtype) {
case mu_Inv:
mu_Send ( mu_InvAck, mu_msg.mu_fwd, (int)mu_p, mu_response_chanel, mu_1_Value_undefined_var, mu_1_Ack_Cnt_undefined_var, mu_1_Node_undefined_var );
mu_Send ( mu_InvAck, (int)mu_HomeType, (int)mu_p, mu_response_chanel, mu_1_Value_undefined_var, mu_1_Ack_Cnt_undefined_var, mu_1_Node_undefined_var );
mu_ps = mu_P_I;
mu_pv.undefine();
break;
default:
...
{
bool mu__boolexpr17;
  if (!(!(mu_msg.mu_ack_cnt.isundefined()))) mu__boolexpr17 = FALSE ;
  else {
  mu__boolexpr17 = ((mu_msg.mu_ack_cnt) == (0)) ; 
}
if ( mu__boolexpr17 )
{
mu_ps = mu_P_M;
...
switch ((int) mu_msg.mu_mtype) {
case mu_FwdGetS:
mu_Send ( mu_FwdAck, (int)mu_HomeType, (int)mu_p, mu_response_chanel, mu_pv, mu_1_Ack_Cnt_undefined_var, mu_1_Node_undefined_var );
mu_Send ( mu_Data, mu_msg.mu_fwd, (int)mu_p, mu_response_chanel, mu_pv, mu_1_Ack_Cnt_undefined_var, mu_1_Node_undefined_var );
mu_ps = mu_P_O;
break;
case mu_FwdGetM:
mu_Send ( mu_FwdAck, (int)mu_HomeType, (int)mu_p, mu_response_chanel, mu_pv, mu_1_Ack_Cnt_undefined_var, mu_1_Node_undefined_var );
mu_Send ( mu_Data, mu_msg.mu_fwd, (int)mu_p, mu_response_chanel, mu_pv, 0, mu_1_Node_undefined_var );
mu_ps = mu_P_I;
mu_pv.undefine();
break;
case mu_Ack_Count:
...
public:
  ...
  void NextRule(unsigned & what_rule)
  {
    ...
    mu_n.unionassign(r % 4);
    r = r / 4;
    while (what_rule < 36 && mu_midx.value()<6 )
      {
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_n.value((r % 3) + 1);
    r = r / 3;
    return tsprintf("writeback from S to I, n:%s", mu_n.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_Proc mu_n;
  ...
  mu_1_Value& mu_pv = mu_Procs[mu_n].mu_val;
  ...
  mu_1_ProcState& mu_p = mu_Procs[mu_n];
  mu_1_Value& mu_pv = mu_Procs[mu_n].mu_val;
mu_Send ( mu_PutS, (int)mu_HomeType, (int)mu_n, mu_request_chanel, mu_1_Value_undefined_var, mu_1_Ack_Cnt_undefined_var, mu_1_Node_undefined_var );
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_n.value((r % 3) + 1);
    r = r / 3;
    return tsprintf("writeback from E to I, n:%s", mu_n.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_Proc mu_n;
  ...
  mu_1_ProcState& mu_p = mu_Procs[mu_n];
  mu_1_Value& mu_pv = mu_Procs[mu_n].mu_val;
mu_Send ( mu_PutM, (int)mu_HomeType, (int)mu_n, mu_request_chanel, mu_p.mu_val, mu_1_Ack_Cnt_undefined_var, mu_1_Node_undefined_var );
mu_p.mu_state = mu_P_EI_A;
  };
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_n.value((r % 3) + 1);
    r = r / 3;
    return tsprintf("writeback from O to I, n:%s", mu_n.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_Proc mu_n;
  ...
  mu_1_ProcState& mu_p = mu_Procs[mu_n];
  mu_1_Value& mu_pv = mu_Procs[mu_n].mu_val;
mu_Send ( mu_PutO, (int)mu_HomeType, (int)mu_n, mu_request_chanel, mu_p.mu_val, mu_1_Ack_Cnt_undefined_var, mu_1_Node_undefined_var );
mu_p.mu_state = mu_P_OI_A;
  };
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_n.value((r % 3) + 1);
    r = r / 3;
    return tsprintf("writeback from M to I, n:%s", mu_n.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_Proc mu_n;
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_n.value((r % 3) + 1);
    r = r / 3;
    return tsprintf("store from O to M, n:%s", mu_n.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_Proc mu_n;
  ...
  mu_1_ProcState& mu_p = mu_Procs[mu_n];
  mu_1_Value& mu_pv = mu_Procs[mu_n].mu_val;
mu_Send ( mu_GetM, (int)mu_HomeType, (int)mu_n, mu_request_chanel, mu_1_Value_undefined_var, mu_1_Ack_Cnt_undefined_var, mu_1_Node_undefined_var );
mu_p.mu_state = mu_P_OM_AC;
  };
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_n.value((r % 3) + 1);
    r = r / 3;
    return tsprintf("store from S to M, n:%s", mu_n.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_Proc mu_n;
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_n.value((r % 3) + 1);
    r = r / 3;
    return tsprintf("store from E to M, n:%s", mu_n.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_Proc mu_n;
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_n.value((r % 3) + 1);
    r = r / 3;
    return tsprintf("store from I to M, n:%s", mu_n.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_Proc mu_n;
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_n.value((r % 3) + 1);
    r = r / 3;
    return tsprintf("read from I to S or E, n:%s", mu_n.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_Proc mu_n;
  ...
  mu_1_ProcState& mu_p = mu_Procs[mu_n];
  mu_1_Value& mu_pv = mu_Procs[mu_n].mu_val;
mu_Send ( mu_GetS, (int)mu_HomeType, (int)mu_n, mu_request_chanel, mu_1_Value_undefined_var, mu_1_Ack_Cnt_undefined_var, mu_1_Node_undefined_var );
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_n.value((r % 3) + 1);
    r = r / 3;
    return tsprintf("Self-downgrade (spontaneous M→E), n:%s", mu_n.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_Proc mu_n;
  ...
  mu_1_ProcState& mu_p = mu_Procs[mu_n];
  mu_1_Value& mu_pv = mu_Procs[mu_n].mu_val;
mu_Send ( mu_DowngradeMtoE, (int)mu_HomeType, (int)mu_n, mu_downgrade_channel, mu_pv, mu_1_Ack_Cnt_undefined_var, mu_1_Node_undefined_var );
mu_p.mu_state = mu_P_ME_A;
  };
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_n.value((r % 3) + 1);
    r = r / 3;
    return tsprintf("store from M to M , v:%s, n:%s", mu_v.Name(), mu_n.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_Value mu_v;
...
bool Condition(unsigned r)
{
  ...
  if (r>=12 && r<=35) return R1.Condition(r-12);
  ...
  if (r>=63 && r<=65) return R11.Condition(r-63);
  if (r>=66 && r<=71) return R12.Condition(r-66);
Error.Notrace("Internal: NextStateGenerator -- checking condition for nonexisting rule.");
}
void Code(unsigned r)
{
  if (r<=11) { R0.Code(r-0); return; } 
  if (r>=12 && r<=35) { R1.Code(r-12); return; } 
  ...
  if (r>=63 && r<=65) { R11.Code(r-63); return; } 
  if (r>=66 && r<=71) { R12.Code(r-66); return; } 
}
int Priority(unsigned short r)
{
  if (r<=11) { return R0.Priority(); } 
  if (r>=12 && r<=35) { return R1.Priority(); } 
  ...
  if (r>=63 && r<=65) { return R11.Priority(); } 
  if (r>=66 && r<=71) { return R12.Priority(); } 
}
char * Name(unsigned r)
{
  if (r<=11) return R0.Name(r-0);
  if (r>=12 && r<=35) return R1.Name(r-12);
  ...
  if (r>=63 && r<=65) return R11.Name(r-63);
  if (r>=66 && r<=71) return R12.Name(r-66);
  return NULL;
}
};
...
/********************
  Invariant records
 ********************/
int mu__invariant_18() // Invariant "P_S & H_S or P_E & H_E or P_O & H_O match memory"
{
bool mu__quant19; 
mu__quant19 = TRUE;
{
...
bool mu__boolexpr22;
bool mu__boolexpr23;
  if (!((mu_HomeNode.mu_state) == (mu_H_S))) mu__boolexpr23 = FALSE ;
  else {
  mu__boolexpr23 = ((mu_Procs[mu_n].mu_state) == (mu_P_S)) ; 
}
  if (mu__boolexpr23) mu__boolexpr22 = TRUE ;
  else {
bool mu__boolexpr24;
  if (!((mu_HomeNode.mu_state) == (mu_H_E))) mu__boolexpr24 = FALSE ;
  else {
  mu__boolexpr24 = ((mu_Procs[mu_n].mu_state) == (mu_P_E)) ; 
}
...
bool mu__boolexpr25;
  if (!((mu_HomeNode.mu_state) == (mu_H_O))) mu__boolexpr25 = FALSE ;
  else {
  mu__boolexpr25 = ((mu_Procs[mu_n].mu_state) == (mu_P_O)) ; 
}
  mu__boolexpr21 = (mu__boolexpr25) ; 
}
  if (!(mu__boolexpr21)) mu__boolexpr20 = TRUE ;
  else {
  mu__boolexpr20 = ((mu_HomeNode.mu_val) == (mu_Procs[mu_n].mu_val)) ; 
}
if ( !(mu__boolexpr20) )
...
bool mu__condition_26() // Condition for Rule "P_S & H_S or P_E & H_E or P_O & H_O match memory"
{
...
int mu__invariant_27() // Invariant "values in memory matches value of last write, when in H_S, H_I or H_O"
{
bool mu__quant28; 
mu__quant28 = TRUE;
{
...
bool mu__boolexpr30;
bool mu__boolexpr31;
  if ((mu_HomeNode.mu_state) == (mu_H_S)) mu__boolexpr31 = TRUE ;
  else {
  mu__boolexpr31 = ((mu_HomeNode.mu_state) == (mu_H_I)) ; 
}
  if (mu__boolexpr31) mu__boolexpr30 = TRUE ;
  else {
  mu__boolexpr30 = ((mu_HomeNode.mu_state) == (mu_H_O)) ; 
}
  if (!(mu__boolexpr30)) mu__boolexpr29 = TRUE ;
  else {
  mu__boolexpr29 = ((mu_HomeNode.mu_val) == (mu_LastWrite)) ; 
}
if ( !(mu__boolexpr29) )
...
bool mu__condition_32() // Condition for Rule "values in memory matches value of last write, when in H_S, H_I or H_O"
{
...
int mu__invariant_33() // Invariant "Homenode.state is in I or M or E implies empty sharer list"
{
bool mu__boolexpr34;
bool mu__boolexpr35;
bool mu__boolexpr36;
  if ((mu_HomeNode.mu_state) == (mu_H_I)) mu__boolexpr36 = TRUE ;
  else {
  mu__boolexpr36 = ((mu_HomeNode.mu_state) == (mu_H_M)) ; 
}
  if (mu__boolexpr36) mu__boolexpr35 = TRUE ;
  else {
  mu__boolexpr35 = ((mu_HomeNode.mu_state) == (mu_H_E)) ; 
}
...
/*** end multisetcount 5 declaration ***/
  mu__boolexpr34 = ((mu__intexpr37) == (0)) ; 
}
return mu__boolexpr34;
};

bool mu__condition_38() // Condition for Rule "Homenode.state is in I or M or E implies empty sharer list"
{
...
int mu__invariant_39() // Invariant "value is undefined while invalid"
{
bool mu__quant40; 
mu__quant40 = TRUE;
{
for(int mu_n = 1; mu_n <= 3; mu_n++) {
bool mu__boolexpr41;
  if (!((mu_Procs[mu_n].mu_state) == (mu_P_I))) mu__boolexpr41 = TRUE ;
  else {
  mu__boolexpr41 = (mu_Procs[mu_n].mu_val.isundefined()) ; 
}
if ( !(mu__boolexpr41) )
...
bool mu__condition_42() // Condition for Rule "value is undefined while invalid"
{
...
int mu__invariant_43() // Invariant "P.state is in S or M or E or O match last write"
{
bool mu__quant44; 
mu__quant44 = TRUE;
{
...
bool mu__boolexpr47;
bool mu__boolexpr48;
  if ((mu_Procs[mu_n].mu_state) == (mu_P_S)) mu__boolexpr48 = TRUE ;
  else {
  mu__boolexpr48 = ((mu_Procs[mu_n].mu_state) == (mu_P_M)) ; 
}
  if (mu__boolexpr48) mu__boolexpr47 = TRUE ;
  else {
  mu__boolexpr47 = ((mu_Procs[mu_n].mu_state) == (mu_P_E)) ; 
}
  if (mu__boolexpr47) mu__boolexpr46 = TRUE ;
  else {
  mu__boolexpr46 = ((mu_Procs[mu_n].mu_state) == (mu_P_O)) ; 
}
  if (!(mu__boolexpr46)) mu__boolexpr45 = TRUE ;
  else {
  mu__boolexpr45 = ((mu_Procs[mu_n].mu_val) == (mu_LastWrite)) ; 
}
if ( !(mu__boolexpr45) )
...
bool mu__condition_49() // Condition for Rule "P.state is in S or M or E or O match last write"
{
...
int mu__invariant_50() // Invariant "value in memory matches value of last write, when invalid"
{
bool mu__boolexpr51;
  if (!((mu_HomeNode.mu_state) == (mu_H_I))) mu__boolexpr51 = TRUE ;
  else {
  mu__boolexpr51 = ((mu_HomeNode.mu_val) == (mu_LastWrite)) ; 
}
return mu__boolexpr51;
};

bool mu__condition_52() // Condition for Rule "value in memory matches value of last write, when invalid"
{
...
int mu__invariant_53() // Invariant "HomeNode.state is in I or S implies empty owner"
{
bool mu__boolexpr54;
bool mu__boolexpr55;
  if ((mu_HomeNode.mu_state) == (mu_H_I)) mu__boolexpr55 = TRUE ;
  else {
  mu__boolexpr55 = ((mu_HomeNode.mu_state) == (mu_H_S)) ; 
}
...
bool mu__condition_56() // Condition for Rule "HomeNode.state is in I or S implies empty owner"
{
...
{"HomeNode.state is in I or S implies empty owner", &mu__condition_56, NULL, FALSE},
{"value in memory matches value of last write, when invalid", &mu__condition_52, NULL, FALSE},
{"P.state is in S or M or E or O match last write", &mu__condition_49, NULL, FALSE},
{"value is undefined while invalid", &mu__condition_42, NULL, FALSE},
{"Homenode.state is in I or M or E implies empty sharer list", &mu__condition_38, NULL, FALSE},
{"values in memory matches value of last write, when in H_S, H_I or H_O", &mu__condition_32, NULL, FALSE},
{"P_S & H_S or P_E & H_E or P_O & H_O match memory", &mu__condition_26, NULL, FALSE},
};
...
void mu_1_Ack_Cnt::Permute(PermSet& Perm, int i) {};
void mu_1_Ack_Cnt::SimpleCanonicalize(PermSet& Perm) {};
void mu_1_Ack_Cnt::Canonicalize(PermSet& Perm) {};
void mu_1_Ack_Cnt::SimpleLimit(PermSet& Perm) {};
void mu_1_Ack_Cnt::ArrayLimit(PermSet& Perm) {};
void mu_1_Ack_Cnt::Limit(PermSet& Perm) {};
void mu_1_Ack_Cnt::MultisetLimit(PermSet& Perm)
{ Error.Error("Internal: calling MultisetLimit for subrange type.\n"); };
...
void mu_1_Message::SimpleCanonicalize(PermSet& Perm)
{
  ...
  mu_fwd.SimpleCanonicalize(Perm);
};
                ...
                for (j=0; j<count_mu_1_Proc; j++) //scan through element priority
                  {
                    ...
                    for (k=0; k<current_size; k++) // scan array index
                      // set goodsets
                      if (pos_multisetindex[i][k] 
                          && !(*this)[k].mu_fwd.isundefined()
                          && (*this)[k].mu_fwd>=1
                          && (*this)[k].mu_fwd<=3
                          && pos_mu_1_Proc[j][(*this)[k].mu_fwd-1])
                        {
                          exists = TRUE;
                          goodset_multisetindex[k] = TRUE;
                          goodset_mu_1_Proc[(*this)[k].mu_fwd-1] = TRUE;
                        }
                    if (exists)
                      {
                        // set split for the array index type
  ...
  if (Perm.MTO_class_mu_1_Proc() && count_mu_1_Proc<3)
    {
      ...
      // if there exists both self loop and non-self loop
      for (k=0; k<3; k++) // step through class
        if ((*this)[k+1][i0].mu_fwd.isundefined()
            ||(*this)[k+1][i0].mu_fwd!=k+1)
          exists = TRUE;
        else
          split = TRUE;
      if (exists && split)
          ...
          for (i=0; i<count_mu_1_Proc; i++) // for value priority
            {
              ...
              for (k=0; k<3; k++) // step through class
                if (pos_mu_1_Proc[i][k] 
                    && !(*this)[k+1][i0].mu_fwd.isundefined()
                    && (*this)[k+1][i0].mu_fwd==k+1)
                  {
                    exists = TRUE;
                    goodset_mu_1_Proc[k] = TRUE;
      ...
      if (Perm.MTO_class_mu_1_Proc() && count_mu_1_Proc<3)
        {
          ...
          for (k=0; k<3; k++) // step through class
            if (!(*this)[k+1][i0].mu_fwd.isundefined()
                &&(*this)[k+1][i0].mu_fwd!=k+1
                &&(*this)[k+1][i0].mu_fwd>=1
                &&(*this)[k+1][i0].mu_fwd<=3)
              exists = TRUE;
          if (exists)
            {
              for (i=0; i<count_mu_1_Proc; i++) // for value priority
                  ...
                  for (j=0; j<count_mu_1_Proc; j++) // for value priority
                    {
                      ...
                      for (k=0; k<3; k++) // step through class
                        if (pos_mu_1_Proc[i][k] 
                            ...
                            && (*this)[k+1][i0].mu_fwd>=1
                            && (*this)[k+1][i0].mu_fwd<=3
                            && pos_mu_1_Proc[j][(*this)[k+1][i0].mu_fwd-1])
                          {
                            exists = TRUE;
                            goodset_mu_1_Proc[k] = TRUE;
                          }
